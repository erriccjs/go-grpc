...
var fileDescriptor_a0b84a42fa06f626 = []byte{
	...
	0xd8, 0x73, 0x53, 0x8b, 0x8b, 0x13, 0xd3, 0x61, 0xea, 0x60, 0x5c, 0x23, 0x47, 0x2e, 0x4e, 0xb0,
	0xd2, 0xcc, 0xbc, 0xf4, 0x62, 0x21, 0x13, 0x2e, 0x56, 0x30, 0x47, 0x48, 0x58, 0x0f, 0x6c, 0x99,
	0x1e, 0xb2, 0x4d, 0x52, 0x22, 0xa8, 0x82, 0x10, 0xa3, 0x95, 0x18, 0x92, 0xd8, 0xc0, 0xee, 0x33,
	0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x50, 0xd4, 0x78, 0x5f, 0xb0, 0x00, 0x00, 0x00,
}
...
func (c *greetingsClient) Greet(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hello.Greetings/Greet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greetings_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hello.Greetings/Greet",
	}
